...
export default async function addCartItems(context, currentItems, inputItems, options = {}) {
  ...
  const promises = inputItems.map(async (inputItem) => {
    ...
    console.log("Parent Variant ",parentVariant)
    ...
    console.log("variant Price Info is ",variantPriceInfo)
    ...
    console.log("MinOrderQuatity is ",minOrderQuantity,quantity)
    console.log("Chosen variant is ",chosenVariant)
